...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> validationError( MethodArgumentNotValidException ex,  HttpServletRequest request){
      ValidationError  errors = new ValidationError("Validation error", "Erro na validação dos campos", request.getRequestURI(), HttpStatus.BAD_REQUEST.value(), System.currentTimeMillis());
